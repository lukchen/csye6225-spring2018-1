...
AWS.config.update({ 
    accessKeyId: 'AKIAJNGKWTCDNHKQQEYQ', 
    secretAccessKey: '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', 
    region: 'us-east-1' 
});
var s3 = new AWS.S3();
var s3Bucket = new AWS.S3( { params: {Bucket: 's3.csye6225-spring2018-zenan.me'} } )
...
class ImageController {
    ...
    async imageRead(ctx) {
        ...
        var urlParams = {Bucket: 's3.csye6225-spring2018-zenan.me', Key: user};
    ...
    async imageDelete(ctx) {
        ...
        var params = {Bucket: "s3.csye6225-spring2018-zenan.me", Key: user};
